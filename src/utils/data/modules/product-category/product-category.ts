export const PRODUCT_CATEGORY_ATTRIBUTES = [
  ...
  },
  {
    ...
    label: "Handle",
    description:
      "URL-friendly identifier for the category (used in category URLs)",
  ...
  },
  {
    ...
    label: "Is Internal",
    description:
      "Whether the category is for internal use only (not visible to customers)",
    examples: ["true", "false"],
  },
  {
  ...
  },
  {
    ...
    description:
      "Unique identifier of the parent category (null for top-level categories)",
  ...
  },
  {
    ...
    label: "Created At",
    description:
      "Date and time when the category was created (ISO 8601 format)",
    examples: [
  ...
  },
  {
    ...
    label: "Updated At",
    description:
      "Date and time when the category was last updated (ISO 8601 format)",
    examples: [
      "2024-01-15T10:30:00Z",
      "2024-12-25T00:00:00Z",
    ],
